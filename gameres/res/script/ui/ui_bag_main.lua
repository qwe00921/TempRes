...
p.ID_CTRL_BUTTON_CLEAR				    = 8;	--背包整理按钮
p.ID_CTRL_PICTURE_NUM					    = 1;	--物品数量及上线的背景
p.ID_CTRL_PICTURE_TITLE				   = 2;	--背包界面title
p.ID_CTRL_BUTTON_BACK					    = 3;	--返回按钮
p.ID_CTRL_PICTURE_BGTITLE				 = 4;	--背景1
