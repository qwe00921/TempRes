...
function CreateMsg( idmsg )
    ...
    elseif idmsg == MSG_PLAYER_EDIT_RESULT then       
        msg = msg_player_edit_result:new(); 
    ...
    elseif idmsg == MSG_MISC_DRAMA then
        msg = msg_drama:new();         
        
    elseif idmsg == MSG_MAILBOX then
        msg = msg_mailbox:new();    
        
    elseif idmsg == MSG_MAILBOX_DELETE then 
        msg = msg_mailbox_delete:new();    
    
    elseif idmsg == MSG_MAILBOX_ONE then 
        msg = msg_mailbox_one:new();      
        
    elseif idmsg == MSG_MAILBOX_SEND then 
        msg = msg_mailbox_send:new();     
