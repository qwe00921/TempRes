...
DoFile("http/msg/msg_player_edit_result.lua")
DoFile("http/msg/msg_drama.lua")
DoFile("http/msg/msg_mailbox.lua")
DoFile("http/msg/msg_mailbox_delete.lua")
DoFile("http/msg/msg_mailbox_one.lua")
DoFile("http/msg/msg_mailbox_send.lua")
